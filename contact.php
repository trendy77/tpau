   ...
   <div class="parallax"><img src="timg/3.jpg" alt=""></div>
		<div class="section black">
           ...
           <h5 class="blue-text">@offices:global</h5>
			...
			<div class="row">
        	     <div class="col s4">
			 <li><a class="grey-text text-lighten-4">277/21050 Warner Ctr Lane,</li></div>
			 <div class="col s4">
					 <li><a class="grey-text text-lighten-4">Suite 3, 34 Cromwell Rd,</li></div>
			     <div class="col s4">
			 <li><a class="grey-text text-lighten-4">15th Floor, Ploenchit Center, 2 Sukhumvit Rd,</li></div>
					 </div>	
			<div class="row">
        	     <div class="col s4">
