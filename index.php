...
<a class="btn btn-floating btn-large deep-orange pulse"><i class="material-icons">video_library</i></a>
  <p class="white-text">Identify engaged users with mathematical precision.</p>
     </div>
    </div>
    <div class="col m4 s12">
     <div class="icon-block">
  ...
  <div class="container grey" id="platforms">
    <?php require_once('./platforms.php'); ?>
  </div>
 </div>
 </section>
<section>
 <div class="container green" id="social">
