...
<<<<<<< HEAD
			...
			|  <a class="grey-text text-lighten-3" style="font-size: 14px"  href="//trendypublishing.com.au/advertise.php">Advertise</a>
			|  <a class="grey-text text-lighten-3" style="font-size: 14px"  href="//trendypublishing.com.au/terms/index.php">Terms</a>
			|  <a class="grey-text text-lighten-3" style="font-size: 14px"  href="//trendypublishing.com.au/login.php">Member Login</a>
			 |  <a class="grey-text text-lighten-3" style="font-size: 14px"  href="//trendypublishing.com.au/contact.php">Contact</a>
		</div>
	</div>
...
>>>>>>> 07b50c5df7c221e4befea4c3e5e21e0fd669ac9f
		<div class="container center-align" id="contact">
			<div class="row">
				...
				<div class="row">   	   
			   		<div class="col s4 l4">	
	  	   			<h5 class="red-text" style="font-family:tinyHands">USA</h5>
					<ul>
							...
							<li><a class="white-text text-lighten-4">usaccounts@trendypublishing.com</li>
					</ul>
					</div>
					<div class="col s4 l4">		
						<h5 class="green-text" style="font-family:tinyHands">Australia</h5>
							...
							<br>
							<li><a class="white-text text-lighten-4">enquiries@trendypublishing.com.au</li>
							<li><a class="white-text text-lighten-4">exec@trendypublishing.com.au</li>
							</ul>
					</div>
					<div class="col s4 l4">		
							<h5 class="yellow-text" style="font-family:tinyHands">Thailand</h5>
						<ul>	<li><a class="grey-text center-align"><b>APAC Accounts</b></li>
						<br><li><a class="grey-text text-lighten-4 center-align"><b>Klongtoey, Bangkok</b></li><br>
							<li><a class="white-text text-lighten-4 center-align">apacaccounts@trendypublishing.com</li>
							</ul>
					</div>
				</div>
		</div>
